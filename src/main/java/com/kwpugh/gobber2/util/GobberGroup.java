...
public class GobberGroup
{
    ...
    private static final ItemGroup GOBBER2_GROUP = FabricItemGroup.builder(new Identifier(Gobber2.MOD_ID, "gobber2_group"))
            .icon(() -> new ItemStack(ItemInit.GOBBER2_SWORD_NETHER))
...
//
//        @Override
//        protected void addItems(FeatureSet enabledFeatures, ItemGroup.Entries entries, boolean hasPermission)
//        {
//            entries.add(BlockInit.GOBBER2_LUCKY_BLOCK);
//            entries.add(BlockInit.GOBBER2_LUCKY_BLOCK_DEEPSLATE);
//            entries.add(BlockInit.GOBBER2_LUCKY_BLOCK_NETHER);
